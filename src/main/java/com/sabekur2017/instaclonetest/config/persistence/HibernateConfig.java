package com.sabekur2017.instaclonetest.config.persistence;
...
@EnableJpaRepositories("com.sabekur2017.instaclonetest.repositories")
    ...
    public SessionFactory createAndGetLocalSessionFactoryBean() {
        if (this.sessionFactory == null) {
            try {
                ...
                configuration.addPackage("com.sabekur2017.instaclonetest.model");
                for (Class<?> clazz : (new Reflections("com.sabekur2017.instaclonetest.model")).getTypesAnnotatedWith(Entity.class)) {
